      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredLogs.map(log => (
            <div key={log.activity_id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 p-6 hover:shadow-md transition-shadow">
